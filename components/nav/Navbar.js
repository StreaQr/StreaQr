            ...
            <section style={{ zIndex: 100, position: "sticky" }} id="navbar">
                <div className="align">
                    ...
                    <header id="ToggleMenu" >
                        ...
                        <nav>
                            <ul>
                                <li style={{ lineHeight: 1.5, }}><Link href={"/"} passHref><a >Home</a></Link></li>
                                <li style={{ lineHeight: 1.5 }}><Link href={"/#about"} passHref><a  >About</a></Link></li>
                                <li style={{ lineHeight: 1.5 }}><Link href={"/#contact"} passHref><a >Contact us</a ></Link></li>
                            </ul>
                        </nav>
                    </header>
